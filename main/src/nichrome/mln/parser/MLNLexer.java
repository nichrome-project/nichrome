...
public class MLNLexer extends Lexer {
				...
				loop6: do {
					...
					switch (alt6) {
						...
						// MLN.g:66:6: escaped= ESC
						{
							...
							mESC();
							escaped =
								new CommonToken(input,
									Token.INVALID_TOKEN_TYPE,
									Token.DEFAULT_CHANNEL, escapedStart585,
									getCharIndex() - 1);
							lBuf.append(getText());
	...
	public final void mESC() throws RecognitionException {
		try {
			...
			// MLN.g:74:5: ( '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\''
			// | '/' | '\\\\' | 'u' i= HEXDIGIT j= HEXDIGIT k= HEXDIGIT l=
			// HEXDIGIT | ~ ( 'u' | 'r' | 'n' | 't' | 'b' | 'f' | '\"' | '\\'' |
			// '/' | '\\\\' ) ) )
			// MLN.g:74:9: '\\\\' ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' |
			// '/' | '\\\\' | 'u' i= HEXDIGIT j= HEXDIGIT k= HEXDIGIT l=
			// HEXDIGIT | ~ ( 'u' | 'r' | 'n' | 't' | 'b' | 'f' | '\"' | '\\'' |
			// '/' | '\\\\' ) )
			{
				match('\\');
				// MLN.g:75:9: ( 'n' | 'r' | 't' | 'b' | 'f' | '\"' | '\\'' |
				// '/' | '\\\\' | 'u' i= HEXDIGIT j= HEXDIGIT k= HEXDIGIT l=
				// HEXDIGIT | ~ ( 'u' | 'r' | 'n' | 't' | 'b' | 'f' | '\"' |
				// '\\'' | '/' | '\\\\' ) )
				int alt7 = 11;
				...
				if ((LA7_0 == 'n')) {
					...
					|| (LA7_0 >= 'c' && LA7_0 <= 'e')
					|| (LA7_0 >= 'g' && LA7_0 <= 'm')
					|| (LA7_0 >= 'o' && LA7_0 <= 'q') || LA7_0 == 's' || (LA7_0 >= 'v' && LA7_0 <= '\uFFFF'))) {
					alt7 = 11;
				} else {
					NoViableAltException nvae =
				...
				switch (alt7) {
					...
					// MLN.g:83:17: '\\\\'
					{
						...
						break;
					case 10:
					// MLN.g:84:11: 'u' i= HEXDIGIT j= HEXDIGIT k= HEXDIGIT l=
					// HEXDIGIT
					{
						match('u');
						...
						mHEXDIGIT();
						i =
							new CommonToken(input, Token.INVALID_TOKEN_TYPE,
								Token.DEFAULT_CHANNEL, iStart871,
								getCharIndex() - 1);
						int jStart875 = getCharIndex();
						mHEXDIGIT();
						j =
							new CommonToken(input, Token.INVALID_TOKEN_TYPE,
								Token.DEFAULT_CHANNEL, jStart875,
								getCharIndex() - 1);
						int kStart879 = getCharIndex();
						mHEXDIGIT();
						k =
							new CommonToken(input, Token.INVALID_TOKEN_TYPE,
								Token.DEFAULT_CHANNEL, kStart879,
								getCharIndex() - 1);
						int lStart883 = getCharIndex();
						mHEXDIGIT();
						l =
							new CommonToken(input, Token.INVALID_TOKEN_TYPE,
								Token.DEFAULT_CHANNEL, lStart883,
								getCharIndex() - 1);

						String num =
							i.getText() + j.getText() + k.getText()
								+ l.getText();
	...
	public final void mID() throws RecognitionException {
		try {
			int _type = ID;
			int _channel = DEFAULT_TOKEN_CHANNEL;
			// MLN.g:113:3: ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' ..
			// 'Z' | '0' .. '9' | '_' | '-' )* )
			// MLN.g:113:7: ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' .. 'z' | 'A' ..
			// 'Z' | '0' .. '9' | '_' | '-' )*
			{
				...
				loop22: do {
					...
					if ((LA22_0 == '-' || (LA22_0 >= '0' && LA22_0 <= '9')
						|| (LA22_0 >= 'A' && LA22_0 <= 'Z') || LA22_0 == '_' || (LA22_0 >= 'a' && LA22_0 <= 'z'))) {
						alt22 = 1;
					}
	...
	public void mTokens() throws RecognitionException {
		// MLN.g:1:8: ( T__21 | T__22 | T__23 | T__24 | T__25 | T__26 | T__27 |
		// T__28 | T__29 | T__30 | T__31 | T__32 | T__33 | T__34 | T__35 | T__36
		// | T__37 | T__38 | T__39 | T__40 | T__41 | T__42 | T__43 | T__44 |
		// T__45 | T__46 | T__47 | T__48 | T__49 | T__50 | T__51 | T__52 | T__53
		// | T__54 | T__55 | T__56 | T__57 | T__58 | T__59 | T__60 | T__61 | WS
		// | COMMENT | NOT | PLUS | MINUS | ASTERISK | PERIOD | EXIST | IMPLIES
		// | STRING | NUMBER | ID )
		int alt23 = 53;
	...
	static final String DFA8_eotS = "\1\uffff\1\5\1\uffff\1\5\2\uffff\3\5";
	static final String DFA8_eofS = "\11\uffff";
	static final String DFA8_minS = "\1\53\1\56\1\60\1\56\2\uffff\3\56";
	static final String DFA8_maxS =
		"\1\71\1\145\1\71\1\145\2\uffff\1\71\1\145\1\71";
	static final String DFA8_acceptS = "\4\uffff\1\2\1\1\3\uffff";
	static final String DFA8_specialS = "\11\uffff}>";
	static final String[] DFA8_transitionS = {
		"\1\2\1\uffff\1\2\1\4\1\uffff\1\1\11\3",
		"\1\4\1\uffff\12\4\13\uffff\1\4\37\uffff\1\4", "\1\4\11\6",
		"\1\4\1\uffff\12\7\13\uffff\1\4\37\uffff\1\4", "", "",
		"\1\4\1\uffff\12\10", "\1\4\1\uffff\12\7\13\uffff\1\4\37\uffff\1\4",
		"\1\4\1\uffff\12\10" };
	...
	static final String DFA21_minS = "\1\53\1\uffff\1\56\2\uffff";
	static final String DFA21_maxS = "\1\71\1\uffff\1\145\2\uffff";
	static final String DFA21_acceptS = "\1\uffff\1\1\1\uffff\1\2\1\3";
	...
	static final String DFA23_eofS = "\163\uffff";
	...
	static final String DFA23_acceptS =
		"\2\uffff\1\2\1\3\1\4\1\5\2\uffff\1\11\2\uffff\1\16\1\17\1\22\13"
			...
			+ "\uffff\1\23\1\6";
	static final String DFA23_specialS = "\163\uffff}>";
	static final String[] DFA23_transitionS = {
		"\2\35\2\uffff\1\35\22\uffff\1\35\1\30\1\42\1\13\1\14\1\31\1"
			...
			+ "\16\5\44\1\20\4\44\1\uffff\1\21\1\uffff\1\34", "\1\45", "", "",
		"", "", "\1\50\20\uffff\1\47", "\1\51\17\uffff\1\52", "",
		"\12\43\4\uffff\1\54", "\1\57\40\uffff\1\56", "", "", "", "\1\61",
		"\1\62",
		"\1\44\2\uffff\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\32\44",
		"\1\65", "\1\67", "\1\70", "\1\72", "\1\73", "\1\76\1\75\1\74",
		"\1\100\1\101", "\1\103", "", "\1\105\4\uffff\1\105", "", "", "",
		"\12\43", "\12\43", "\1\111\37\uffff\1\112", "\1\113", "", "", "", "",
		"", "\1\114",
		"\1\44\2\uffff\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\32\44", "", "",
		"", "", "", "\1\116", "", "", "\1\117", "", "", "", "", "",
		"\1\44\2\uffff\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\32\44", "", "",
		...
		"\1\44\2\uffff\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\32\44",
		"\1\44\2\uffff\12\44\7\uffff\32\44\4\uffff\1\44\1\uffff\32\44",
		"\1\150", "\1\152\61\uffff\1\151", "\1\153", "", "\1\154", "", "",
