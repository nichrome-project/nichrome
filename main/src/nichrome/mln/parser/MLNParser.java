// $ANTLR 3.2 Sep 23, 2009 12:02:23 MLN.g 2014-09-23 21:09:39
...
import nichrome.mln.*;
import nichrome.mln.ra.*;
import nichrome.mln.util.*;

public class MLNParser extends Parser {
	public static final String[] tokenNames = new String[] { "<invalid>",
		"<EOR>", "<DOWN>", "<UP>", "WS", "COMMENT", "NOT", "PLUS", "MINUS",
		"ASTERISK", "PERIOD", "EXIST", "IMPLIES", "ESC", "STRING", "HEXDIGIT",
		"INTEGER", "FLOAT", "NUMBER", "EXPONENT", "ID", "'**'", "'@'", "'('",
	...
	public MLNParser(TokenStream input, RecognizerSharedState state) {
		super(input, state);
		this.state.ruleMemo = new HashMap[142 + 1];
	...
	public final MLNParser.definitions_return definitions()
		...
		MLNParser.definitions_return retval =
			new MLNParser.definitions_return();
		...
		try {
			...
			// MLN.g:121:15: schemaList ruleList EOF
			{
				...
				if (state.backtracking == 0)
					adaptor.addChild(root_0, schemaList1.getTree());
				...
				EOF3 = (Token) match(input, EOF, FOLLOW_EOF_in_definitions899);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
			...
			recover(input, re);
			retval.tree =
				(Object) adaptor.errorNode(input, retval.start, input.LT(-1),
					re);

		} finally {
			if (state.backtracking > 0) {
				memoize(input, 1, definitions_StartIndex);
			}
		}
		return retval;
	}
	...
	public final MLNParser.schemaList_return schemaList()
		...
		try {
					...
					switch (alt1) {
						...
						// MLN.g:123:15: schema
						{
							...
							if (state.failed)
								return retval;
							if (state.backtracking == 0)
								adaptor.addChild(root_0, schema4.getTree());
						...
						// MLN.g:123:24: schemaConstraint
						{
							...
							if (state.failed)
								return retval;
							if (state.backtracking == 0)
								adaptor.addChild(root_0, schemaConstraint5
									.getTree());
			...
			if (state.backtracking > 0) {
				memoize(input, 2, schemaList_StartIndex);
			}
		}
		return retval;
	}
	...
	// $ANTLR start "schema"
	// MLN.g:125:1: schema : (du= '+' )? (aa= '**' | a1= ASTERISK )? (vt= '@' )?
	// pname= ID (a2= ASTERISK )? '(' types+= predArg ( ',' types+= predArg )*
	// ')' ;
	public final MLNParser.schema_return schema() throws RecognitionException {
		...
		try {
			...
			// MLN.g:125:8: ( (du= '+' )? (aa= '**' | a1= ASTERISK )? (vt= '@'
			// )? pname= ID (a2= ASTERISK )? '(' types+= predArg ( ',' types+=
			// predArg )* ')' )
			// MLN.g:125:10: (du= '+' )? (aa= '**' | a1= ASTERISK )? (vt= '@' )?
			// pname= ID (a2= ASTERISK )? '(' types+= predArg ( ',' types+=
			// predArg )* ')'
			{
				root_0 = (Object) adaptor.nil();
				...
				switch (alt2) {
					...
					{
						du =
							(Token) match(input, PLUS, FOLLOW_PLUS_in_schema925);
						if (state.failed)
							return retval;
						if (state.backtracking == 0) {
				...
				switch (alt3) {
					...
					// MLN.g:125:21: aa= '**'
					{
						aa = (Token) match(input, 21, FOLLOW_21_in_schema932);
						if (state.failed)
							return retval;
						if (state.backtracking == 0) {
					...
					{
						a1 =
							(Token) match(input, ASTERISK,
								FOLLOW_ASTERISK_in_schema936);
						if (state.failed)
							return retval;
						if (state.backtracking == 0) {
				...
				switch (alt4) {
					...
					// MLN.g:125:44: vt= '@'
					{
						vt = (Token) match(input, 22, FOLLOW_22_in_schema943);
						if (state.failed)
							return retval;
						if (state.backtracking == 0) {
				...
				pname = (Token) match(input, ID, FOLLOW_ID_in_schema949);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
				...
				if (state.backtracking == 0) {
					...
					Predicate pred =
						new Predicate(ml, (pname != null ? pname.getText()
							: null), cwa);
					if (aa != null)
						pred.setCompeletelySpecified(true);
					// if(eqrel) pred.isDedupalogHead = true;
					if (vt != null) {
						// if((vt!=null?vt.getText():null).equals("@"))
						// pred.isInMem = true;
					}
					if (du != null) {
						// if((du!=null?du.getText():null).equals("+"))
						// pred.toDump = true;
					}
					curPred = pred;
				...
				char_literal6 =
					(Token) match(input, 23, FOLLOW_23_in_schema960);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
				...
				if (state.failed)
					return retval;
				if (state.backtracking == 0)
					adaptor.addChild(root_0, types.getTree());
				if (list_types == null)
				...
				loop6: do {
					...
					switch (alt6) {
						...
						{
							char_literal7 =
								(Token) match(input, 24, FOLLOW_24_in_schema967);
							if (state.failed)
								return retval;
							if (state.backtracking == 0) {
								char_literal7_tree =
				...
				char_literal8 =
					(Token) match(input, 25, FOLLOW_25_in_schema975);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
			...
			if (state.backtracking > 0) {
				memoize(input, 3, schema_StartIndex);
			}
		}
		return retval;
	}
	...
	public final MLNParser.predArg_return predArg() throws RecognitionException {
		...
		try {
			...
			// MLN.g:148:11: type= ID (name= ID )? (uni= '!' )?
			{
				...
				type = (Token) match(input, ID, FOLLOW_ID_in_predArg990);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
				...
				switch (alt7) {
					...
					{
						name =
							(Token) match(input, ID, FOLLOW_ID_in_predArg995);
						if (state.failed)
							return retval;
						if (state.backtracking == 0) {
				...
				switch (alt8) {
					...
					{
						uni =
							(Token) match(input, NOT, FOLLOW_NOT_in_predArg1001);
						if (state.failed)
							return retval;
						if (state.backtracking == 0) {
				...
				if (state.backtracking == 0) {
					...
					Type t =
						ml.getOrCreateTypeByName((type != null ? type.getText()
							: null));
					String nm = null;
					if (name != null)
						nm = (name != null ? name.getText() : null);
			...
			if (state.backtracking > 0) {
				memoize(input, 4, predArg_StartIndex);
			}
		}
		return retval;
	}
	...
	public final MLNParser.schemaConstraint_return schemaConstraint()
		throws RecognitionException {
		MLNParser.schemaConstraint_return retval =
			new MLNParser.schemaConstraint_return();
		retval.start = input.LT(1);
		...
		try {
			...
			// MLN.g:161:3: functionalDependency
			{
				...
				if (state.failed)
					return retval;
				if (state.backtracking == 0)
					adaptor.addChild(root_0, functionalDependency9.getTree());
			...
			if (state.backtracking > 0) {
				memoize(input, 5, schemaConstraint_StartIndex);
			}
		}
		return retval;
	}
	...
	public static class functionalDependency_return extends
	...
	// MLN.g:163:1: functionalDependency : ( 'FUNCTIONAL DEPENDENCY' | 'FD' )
	// ':' functionalDependencyItem ( ';' functionalDependencyItem )* ;
	public final MLNParser.functionalDependency_return functionalDependency()
		throws RecognitionException {
		MLNParser.functionalDependency_return retval =
			new MLNParser.functionalDependency_return();
		retval.start = input.LT(1);
		...
		MLNParser.functionalDependencyItem_return functionalDependencyItem12 =
			null;

		MLNParser.functionalDependencyItem_return functionalDependencyItem14 =
			null;
		...
		try {
			...
			// MLN.g:163:22: ( ( 'FUNCTIONAL DEPENDENCY' | 'FD' ) ':'
			// functionalDependencyItem ( ';' functionalDependencyItem )* )
			// MLN.g:164:3: ( 'FUNCTIONAL DEPENDENCY' | 'FD' ) ':'
			// functionalDependencyItem ( ';' functionalDependencyItem )*
			{
				root_0 = (Object) adaptor.nil();
				...
				if ((input.LA(1) >= 26 && input.LA(1) <= 27)) {
					...
					if (state.backtracking == 0)
						adaptor
							.addChild(root_0, (Object) adaptor.create(set10));
				...
				char_literal11 =
					(Token) match(input, 28,
						FOLLOW_28_in_functionalDependency1039);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
					char_literal11_tree =
				...
				if (state.failed)
					return retval;
				if (state.backtracking == 0)
					adaptor.addChild(root_0, functionalDependencyItem12
						.getTree());
						...
						// MLN.g:166:4: ';' functionalDependencyItem
						{
							char_literal13 =
								(Token) match(input, 29,
									FOLLOW_29_in_functionalDependency1048);
							if (state.failed)
								return retval;
							if (state.backtracking == 0) {
								char_literal13_tree =
							...
							if (state.backtracking == 0)
								adaptor.addChild(root_0,
									functionalDependencyItem14.getTree());
			...
			if (state.backtracking > 0) {
				memoize(input, 6, functionalDependency_StartIndex);
			}
		}
		return retval;
	}
	...
	public static class functionalDependencyItem_return extends
		ParserRuleReturnScope {
		Object tree;
	...
	// MLN.g:173:1: functionalDependencyItem : pa+= ID ( ',' pa+= ID )* '->' sa=
	// ID ;
	public final MLNParser.functionalDependencyItem_return
		functionalDependencyItem() throws RecognitionException {
		MLNParser.functionalDependencyItem_return retval =
			new MLNParser.functionalDependencyItem_return();
		retval.start = input.LT(1);
		...
		try {
			...
			// MLN.g:174:3: pa+= ID ( ',' pa+= ID )* '->' sa= ID
			{
				...
				pa =
					(Token) match(input, ID,
						FOLLOW_ID_in_functionalDependencyItem1070);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
						...
						// MLN.g:174:11: ',' pa+= ID
						{
							char_literal15 =
								(Token) match(input, 24,
									FOLLOW_24_in_functionalDependencyItem1073);
							if (state.failed)
								return retval;
							if (state.backtracking == 0) {
								char_literal15_tree =
							...
							pa =
								(Token) match(input, ID,
									FOLLOW_ID_in_functionalDependencyItem1077);
							if (state.failed)
								return retval;
							if (state.backtracking == 0) {
								pa_tree = (Object) adaptor.create(pa);
				...
				string_literal16 =
					(Token) match(input, 30,
						FOLLOW_30_in_functionalDependencyItem1081);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
				...
				sa =
					(Token) match(input, ID,
						FOLLOW_ID_in_functionalDependencyItem1085);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
			...
			if (state.backtracking > 0) {
				memoize(input, 7, functionalDependencyItem_StartIndex);
			}
		}
		return retval;
	}
	...
	public final MLNParser.ruleList_return ruleList()
		...
		try {
					...
					switch (alt11) {
						...
						// MLN.g:189:13: mlnRule
						{
							...
							if (state.failed)
								return retval;
							if (state.backtracking == 0)
								adaptor.addChild(root_0, mlnRule17.getTree());
						...
						// MLN.g:189:23: scopingRule
						{
							...
							if (state.failed)
								return retval;
							if (state.backtracking == 0)
								adaptor.addChild(root_0, scopingRule18
									.getTree());
						...
						// MLN.g:189:37: datalogRule
						{
							...
							if (state.failed)
								return retval;
							if (state.backtracking == 0)
								adaptor.addChild(root_0, datalogRule19
									.getTree());
			...
			if (state.backtracking > 0) {
				memoize(input, 8, ruleList_StartIndex);
			}
		}
		return retval;
	}
	...
	// $ANTLR start "mlnRule"
	// MLN.g:192:1: mlnRule : (tag= ( '[Label]' | '[+Label]' | '[Label+]' )
	// STRING )? ( softRule | hardRule ) ;
	public final MLNParser.mlnRule_return mlnRule() throws RecognitionException {
		...
		try {
			...
			// MLN.g:193:5: ( (tag= ( '[Label]' | '[+Label]' | '[Label+]' )
			// STRING )? ( softRule | hardRule ) )
			...
			// )? ( softRule | hardRule )
			{
				...
				// MLN.g:194:5: (tag= ( '[Label]' | '[+Label]' | '[Label+]' )
				// STRING )?
				int alt12 = 2;
				...
				switch (alt12) {
					case 1:
					// MLN.g:195:6: tag= ( '[Label]' | '[+Label]' | '[Label+]' )
					// STRING
					{
						...
						STRING20 =
							(Token) match(input, STRING,
								FOLLOW_STRING_in_mlnRule1152);
						if (state.failed)
							return retval;
						if (state.backtracking == 0) {
				...
				switch (alt13) {
					...
					// MLN.g:206:6: softRule
					{
						...
						if (state.failed)
							return retval;
						if (state.backtracking == 0)
							adaptor.addChild(root_0, softRule21.getTree());
					...
					// MLN.g:206:17: hardRule
					{
						...
						if (state.failed)
							return retval;
						if (state.backtracking == 0)
							adaptor.addChild(root_0, hardRule22.getTree());
			...
			if (state.backtracking > 0) {
				memoize(input, 9, mlnRule_StartIndex);
			}
		}
		return retval;
	}
	...
	// MLN.g:209:1: softRule returns [Clause c] : ( (du= '@' )? weight= NUMBER
	// fc= foclause | (du= '@' )? warg= ID ':' fc= foclause );
	public final MLNParser.softRule_return softRule()
		...
		try {
			...
			// MLN.g:210:5: ( (du= '@' )? weight= NUMBER fc= foclause | (du= '@'
			// )? warg= ID ':' fc= foclause )
			int alt16 = 2;
			switch (input.LA(1)) {
				case 22: {
			...
			switch (alt16) {
				...
				// MLN.g:210:9: (du= '@' )? weight= NUMBER fc= foclause
				{
					...
					switch (alt14) {
						...
						{
							du =
								(Token) match(input, 22,
									FOLLOW_22_in_softRule1204);
							if (state.failed)
								return retval;
							if (state.backtracking == 0) {
								du_tree = (Object) adaptor.create(du);
					...
					weight =
						(Token) match(input, NUMBER,
							FOLLOW_NUMBER_in_softRule1210);
					if (state.failed)
						return retval;
					if (state.backtracking == 0) {
					...
					if (state.backtracking == 0) {
						...
						retval.c.setWeight(Double.parseDouble((weight != null
							? weight.getText() : null)));
						ml.registerClause(retval.c);
						retval.c.addSpecText(input.toString(retval.start, input
							.LT(-1)));
						if (du != null) {
				...
				// MLN.g:223:5: (du= '@' )? warg= ID ':' fc= foclause
				{
					...
					warg = (Token) match(input, ID, FOLLOW_ID_in_softRule1241);
					if (state.failed)
						return retval;
					if (state.backtracking == 0) {
					...
					char_literal23 =
						(Token) match(input, 28, FOLLOW_28_in_softRule1243);
					if (state.failed)
						return retval;
					if (state.backtracking == 0) {
						char_literal23_tree =
					...
					if (state.backtracking == 0) {
						...
						retval.c.setVarWeight((warg != null ? warg.getText()
							: null));
						ml.registerClause(retval.c);
						retval.c.addSpecText(input.toString(retval.start, input
							.LT(-1)));
			...
			if (state.backtracking > 0) {
				memoize(input, 10, softRule_StartIndex);
			}
		}
		return retval;
	}
		...
		try {
			...
			// MLN.g:241:9: fc= foclause PERIOD
			{
				...
				if (state.backtracking == 0)
					adaptor.addChild(root_0, fc.getTree());
				PERIOD24 =
					(Token) match(input, PERIOD, FOLLOW_PERIOD_in_hardRule1282);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
			...
			if (state.backtracking > 0) {
				memoize(input, 11, hardRule_StartIndex);
			}
		}
		return retval;
	}
	...
	// MLN.g:251:1: functionalAtom returns [AtomEx cond] : func= ID '(' e1=
	// expression ( ',' ep= expression )* ')' ;
	public final MLNParser.functionalAtom_return functionalAtom()
		throws RecognitionException {
		MLNParser.functionalAtom_return retval =
			new MLNParser.functionalAtom_return();
		retval.start = input.LT(1);
		...
		try {
			...
			// ')'
			{
				...
				func =
					(Token) match(input, ID, FOLLOW_ID_in_functionalAtom1317);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
				...
				if (state.backtracking == 0) {
					...
					Predicate p =
						ml.getPredByName((func != null ? func.getText() : null));
					if (p == null)
						die("Line #" + func.getLine()
							+ ": undefined predicate: "
							+ (func != null ? func.getText() : null));
					retval.cond = new AtomEx(p);

				}
				char_literal25 =
					(Token) match(input, 23, FOLLOW_23_in_functionalAtom1330);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
					char_literal25_tree =
				...
				loop17: do {
					...
					switch (alt17) {
						...
						// MLN.g:262:8: ',' ep= expression
						{
							char_literal26 =
								(Token) match(input, 24,
									FOLLOW_24_in_functionalAtom1355);
							if (state.failed)
								return retval;
							if (state.backtracking == 0) {
								char_literal26_tree =
							...
							if (state.failed)
								return retval;
							if (state.backtracking == 0)
								adaptor.addChild(root_0, ep.getTree());
							if (state.backtracking == 0) {
								retval.cond.appendTerm((ep != null ? ep.expr
									: null));
							}
				...
				char_literal27 =
					(Token) match(input, 25, FOLLOW_25_in_functionalAtom1382);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
					char_literal27_tree =
			...
			if (state.backtracking > 0) {
				memoize(input, 12, functionalAtom_StartIndex);
			}
		}
		return retval;
	}
	...
	// MLN.g:268:1: datalogRule returns [ConjunctiveQuery cq = new
	// ConjunctiveQuery();] : (vt= ( '@' | '#' ) )? (st= '$' )? head= literal
	// ':-' body0= literal ( ',' bodyp= literal )* ( ',' mc= mathComparison )* (
	// ',' '[' be= boolExpression ']' )? PERIOD ;
	public final MLNParser.datalogRule_return datalogRule()
		throws RecognitionException {
		MLNParser.datalogRule_return retval =
			new MLNParser.datalogRule_return();
		retval.start = input.LT(1);
		...
		try {
			...
			// MLN.g:269:5: ( (vt= ( '@' | '#' ) )? (st= '$' )? head= literal
			// ':-' body0= literal ( ',' bodyp= literal )* ( ',' mc=
			// mathComparison )* ( ',' '[' be= boolExpression ']' )? PERIOD )
			// MLN.g:269:9: (vt= ( '@' | '#' ) )? (st= '$' )? head= literal ':-'
			// body0= literal ( ',' bodyp= literal )* ( ',' mc= mathComparison
			// )* ( ',' '[' be= boolExpression ']' )? PERIOD
			{
				root_0 = (Object) adaptor.nil();
				...
				string_literal28 =
					(Token) match(input, 36, FOLLOW_36_in_datalogRule1429);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
				...
				if (state.failed)
					return retval;
				if (state.backtracking == 0)
					adaptor.addChild(root_0, body0.getTree());
				if (state.backtracking == 0) {

					if ((body0 != null ? body0.lit : null) != null) {
						retval.cq
							.addBodyLit((body0 != null ? body0.lit : null));
					}
					...
					switch (alt20) {
						...
						// MLN.g:275:10: ',' bodyp= literal
						{
							...
							if (state.failed)
								return retval;
							if (state.backtracking == 0)
								adaptor.addChild(root_0, bodyp.getTree());
							if (state.backtracking == 0) {

								if ((bodyp != null ? bodyp.lit : null) != null) {
									retval.cq.addBodyLit((bodyp != null
										? bodyp.lit : null));
								}
				...
				loop21: do {
					...
					if ((LA21_0 == 24)) {
						...
						if ((LA21_1 == STRING || LA21_1 == NUMBER
							|| LA21_1 == ID || LA21_1 == 23 || LA21_1 == 61)) {
							alt21 = 1;
						}
					...
					switch (alt21) {
						...
						// MLN.g:280:10: ',' mc= mathComparison
						{
							...
							if (state.failed)
								return retval;
							if (state.backtracking == 0)
								adaptor.addChild(root_0, mc.getTree());
							if (state.backtracking == 0) {

								retval.cq.addConstraint((mc != null ? mc.expr
									: null));
				...
				switch (alt22) {
					...
					// MLN.g:283:9: ',' '[' be= boolExpression ']'
					{
						...
						if (state.failed)
							return retval;
						if (state.backtracking == 0)
							adaptor.addChild(root_0, be.getTree());
						if (state.backtracking == 0) {

							retval.cq
								.addConstraint((be != null ? be.be : null));

						}
						char_literal33 =
							(Token) match(input, 38,
								FOLLOW_38_in_datalogRule1519);
						if (state.failed)
							return retval;
						if (state.backtracking == 0) {
							char_literal33_tree =
				...
				PERIOD34 =
					(Token) match(input, PERIOD,
						FOLLOW_PERIOD_in_datalogRule1528);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
				...
				if (state.backtracking == 0) {
					...
					if (st != null) {
						if ((st != null ? st.getText() : null).equals("$"))
							retval.cq.isView = true;
					}
					if (vt != null) {
						if ((vt != null ? vt.getText() : null).equals("@"))
							ml.registerPostprocRule(retval.cq);
			...
			if (state.backtracking > 0) {
				memoize(input, 13, datalogRule_StartIndex);
			}
		}
		return retval;
	}
	...
	// MLN.g:305:1: scopingRule returns [ConjunctiveQuery cq = new
	// ConjunctiveQuery();] : ( '[' 'priorProb' '=' prior= NUMBER ']' )? head=
	// literal ':=' body0= literal ( ',' bodyp= literal )* ( ',' mc=
	// mathComparison )* ( ',' '[' be= boolExpression ']' )? PERIOD ;
	public final MLNParser.scopingRule_return scopingRule()
		throws RecognitionException {
		MLNParser.scopingRule_return retval =
			new MLNParser.scopingRule_return();
		retval.start = input.LT(1);
		...
		try {
			...
			// MLN.g:306:5: ( ( '[' 'priorProb' '=' prior= NUMBER ']' )? head=
			// literal ':=' body0= literal ( ',' bodyp= literal )* ( ',' mc=
			// mathComparison )* ( ',' '[' be= boolExpression ']' )? PERIOD )
			// MLN.g:306:9: ( '[' 'priorProb' '=' prior= NUMBER ']' )? head=
			// literal ':=' body0= literal ( ',' bodyp= literal )* ( ',' mc=
			// mathComparison )* ( ',' '[' be= boolExpression ']' )? PERIOD
			{
				root_0 = (Object) adaptor.nil();
				...
				switch (alt23) {
					...
					// MLN.g:306:10: '[' 'priorProb' '=' prior= NUMBER ']'
					{
						...
						prior =
							(Token) match(input, NUMBER,
								FOLLOW_NUMBER_in_scopingRule1569);
						if (state.failed)
							return retval;
						if (state.backtracking == 0) {
				...
				string_literal39 =
					(Token) match(input, 41, FOLLOW_41_in_scopingRule1581);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
				...
				loop25: do {
					...
					if ((LA25_0 == 24)) {
						...
						if ((LA25_1 == STRING || LA25_1 == NUMBER
							|| LA25_1 == ID || LA25_1 == 23 || LA25_1 == 61)) {
							alt25 = 1;
						}
				...
				PERIOD45 =
					(Token) match(input, PERIOD,
						FOLLOW_PERIOD_in_scopingRule1680);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
				...
				if (state.backtracking == 0) {
					...
					if (prior != null) {
						double pr =
							Double.parseDouble((prior != null ? prior.getText()
								: null));
						if (pr > 1 || pr < 0) {
							die("Line #"
								+ (lineOffset + prior.getLine())
								+ ": "
								+ (prior != null ? prior.getText() : null)
								+ " - probabilities of soft evidence should be in [0,1]");
						} else {
			...
			if (state.backtracking > 0) {
				memoize(input, 14, scopingRule_StartIndex);
			}
		}
		return retval;
	}
	...
	// MLN.g:339:1: foclause returns [Clause c = new Clause()] : (exq= existQuan
	// )? (ant0= literal ( ',' antp= literal )* ( ',' mc= mathComparison )* (
	// ',' '[' be= boolExpression ']' )? IMPLIES )? lit0= literal ( 'v' litp=
	// literal )* ( 'v' mc= mathComparison )* ( 'v' '[' sbe= boolExpression ']'
	// )? ;
	public final MLNParser.foclause_return foclause()
		...
		try {
			...
			// MLN.g:407:5: ( (exq= existQuan )? (ant0= literal ( ',' antp=
			// literal )* ( ',' mc= mathComparison )* ( ',' '[' be=
			// boolExpression ']' )? IMPLIES )? lit0= literal ( 'v' litp=
			// literal )* ( 'v' mc= mathComparison )* ( 'v' '[' sbe=
			// boolExpression ']' )? )
			// MLN.g:407:9: (exq= existQuan )? (ant0= literal ( ',' antp=
			// literal )* ( ',' mc= mathComparison )* ( ',' '[' be=
			// boolExpression ']' )? IMPLIES )? lit0= literal ( 'v' litp=
			// literal )* ( 'v' mc= mathComparison )* ( 'v' '[' sbe=
			// boolExpression ']' )?
			{
				...
				switch (alt27) {
					...
					// MLN.g:0:0: exq= existQuan
					{
						...
						if (state.failed)
							return retval;
						if (state.backtracking == 0)
							adaptor.addChild(root_0, exq.getTree());
				...
				// MLN.g:408:6: (ant0= literal ( ',' antp= literal )* ( ',' mc=
				// mathComparison )* ( ',' '[' be= boolExpression ']' )? IMPLIES
				// )?
				int alt31 = 2;
				alt31 = dfa31.predict(input);
				switch (alt31) {
					case 1:
					// MLN.g:409:9: ant0= literal ( ',' antp= literal )* ( ','
					// mc= mathComparison )* ( ',' '[' be= boolExpression ']' )?
					// IMPLIES
					{
						...
						if (state.failed)
							return retval;
						if (state.backtracking == 0)
							adaptor.addChild(root_0, ant0.getTree());
						if (state.backtracking == 0) {

							if ((ant0 != null ? ant0.lit : null) != null) {
								(ant0 != null ? ant0.lit : null).flipSense();
								retval.c.addLiteral((ant0 != null ? ant0.lit
									: null));
							}
						...
						loop28: do {
							...
							switch (alt28) {
								...
								// MLN.g:415:10: ',' antp= literal
								{
									char_literal46 =
										(Token) match(input, 24,
											FOLLOW_24_in_foclause1752);
									if (state.failed)
										return retval;
									if (state.backtracking == 0) {
										char_literal46_tree =
											(Object) adaptor
												.create(char_literal46);
										adaptor.addChild(root_0,
											char_literal46_tree);
									}
									...
									if (state.backtracking == 0)
										adaptor
											.addChild(root_0, antp.getTree());
									if (state.backtracking == 0) {

										if ((antp != null ? antp.lit : null) != null) {
											(antp != null ? antp.lit : null)
												.flipSense();
											retval.c.addLiteral((antp != null
												? antp.lit : null));
										}
						...
						loop29: do {
							...
							if ((LA29_0 == 24)) {
								...
								if ((LA29_1 == STRING || LA29_1 == NUMBER
									|| LA29_1 == ID || LA29_1 == 23 || LA29_1 == 61)) {
									alt29 = 1;
								}
							...
							switch (alt29) {
								...
								// MLN.g:421:10: ',' mc= mathComparison
								{
									...
									if (state.backtracking == 0) {
										...
										retval.c.addConstraint((mc != null
											? mc.expr : null));
						...
						switch (alt30) {
							...
							// MLN.g:424:8: ',' '[' be= boolExpression ']'
							{
								...
								if (state.backtracking == 0) {
									...
									retval.c.addConstraint((be != null ? be.be
										: null));

								}
								char_literal50 =
									(Token) match(input, 38,
										FOLLOW_38_in_foclause1814);
								if (state.failed)
									return retval;
								if (state.backtracking == 0) {
									char_literal50_tree =
						...
						IMPLIES51 =
							(Token) match(input, IMPLIES,
								FOLLOW_IMPLIES_in_foclause1835);
						if (state.failed)
							return retval;
						if (state.backtracking == 0) {
				...
				if (state.failed)
					return retval;
				if (state.backtracking == 0)
					adaptor.addChild(root_0, lit0.getTree());
				if (state.backtracking == 0) {
					...
					switch (alt32) {
						...
						// MLN.g:433:7: 'v' litp= literal
						{
							...
							if (state.failed)
								return retval;
							if (state.backtracking == 0)
								adaptor.addChild(root_0, litp.getTree());
							if (state.backtracking == 0) {
								retval.c.addLiteral((litp != null ? litp.lit
									: null));
							}
				...
				loop33: do {
					...
					if ((LA33_0 == 42)) {
						...
						if ((LA33_1 == STRING || LA33_1 == NUMBER
							|| LA33_1 == ID || LA33_1 == 23 || LA33_1 == 61)) {
							alt33 = 1;
						}
					...
					switch (alt33) {
						...
						// MLN.g:434:10: 'v' mc= mathComparison
						{
							...
							if (state.backtracking == 0) {
								...
								retval.c.addConstraint(Expression
									.not((mc != null ? mc.expr : null)));
				...
				switch (alt34) {
					...
					{
						char_literal54 =
							(Token) match(input, 42, FOLLOW_42_in_foclause1904);
						if (state.failed)
							return retval;
						if (state.backtracking == 0) {
							char_literal54_tree =
						...
						char_literal55 =
							(Token) match(input, 37, FOLLOW_37_in_foclause1906);
						if (state.failed)
							return retval;
						if (state.backtracking == 0) {
							char_literal55_tree =
						...
						if (state.failed)
							return retval;
						if (state.backtracking == 0)
							adaptor.addChild(root_0, sbe.getTree());
						if (state.backtracking == 0) {

							retval.c.addConstraint(Expression.not((sbe != null
								? sbe.be : null)));

						}
						char_literal56 =
							(Token) match(input, 38, FOLLOW_38_in_foclause1928);
						if (state.failed)
							return retval;
						if (state.backtracking == 0) {
							char_literal56_tree =
			...
			if (state.backtracking > 0) {
				memoize(input, 15, foclause_StartIndex);
			}
		}
		return retval;
	}
	...
	// MLN.g:454:1: existQuan returns [ArrayList<String> vars = new
	// ArrayList<String>()] : EXIST v0= ID ( ',' vp= ID )* ;
	public final MLNParser.existQuan_return existQuan()
		...
		try {
			...
			// MLN.g:455:9: EXIST v0= ID ( ',' vp= ID )*
			{
				...
				EXIST57 =
					(Token) match(input, EXIST, FOLLOW_EXIST_in_existQuan1959);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
				...
				v0 = (Token) match(input, ID, FOLLOW_ID_in_existQuan1971);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
				...
				loop35: do {
					...
					switch (alt35) {
						...
						// MLN.g:457:10: ',' vp= ID
						{
							...
							if (state.backtracking == 0) {
								retval.vars.add((vp != null ? vp.getText()
									: null));
							}
			...
			if (state.backtracking > 0) {
				memoize(input, 16, existQuan_StartIndex);
			}
		}
		return retval;
	}
	...
	public final MLNParser.expression_return expression()
		throws RecognitionException {
	...
	// MLN.g:465:1: boolExpression returns [Expression be] : c0= boolConjunction
	// ( ( '||' | 'OR' ) cp= boolConjunction )* ;
	public final MLNParser.boolExpression_return boolExpression()
		throws RecognitionException {
		MLNParser.boolExpression_return retval =
			new MLNParser.boolExpression_return();
		retval.start = input.LT(1);
		...
		try {
			...
			// MLN.g:466:5: (c0= boolConjunction ( ( '||' | 'OR' ) cp=
			// boolConjunction )* )
			// MLN.g:467:5: c0= boolConjunction ( ( '||' | 'OR' ) cp=
			// boolConjunction )*
			{
				root_0 = (Object) adaptor.nil();
				...
				if (state.failed)
					return retval;
				if (state.backtracking == 0)
					adaptor.addChild(root_0, c0.getTree());
				if (state.backtracking == 0) {
					...
					switch (alt36) {
						...
						// MLN.g:472:9: ( '||' | 'OR' ) cp= boolConjunction
						{
							...
							if (state.failed)
								return retval;
							if (state.backtracking == 0)
								adaptor.addChild(root_0, cp.getTree());
							if (state.backtracking == 0) {
			...
			if (state.backtracking > 0) {
				memoize(input, 18, boolExpression_StartIndex);
			}
		}
		return retval;
	}
	...
	// MLN.g:482:1: boolConjunction returns [Expression be] : c0=
	// boolConjunctionElement ( ( '&&' | 'AND' ) cp= boolConjunctionElement )* ;
	public final MLNParser.boolConjunction_return boolConjunction()
		throws RecognitionException {
		MLNParser.boolConjunction_return retval =
			new MLNParser.boolConjunction_return();
		retval.start = input.LT(1);
		...
		try {
			...
			// MLN.g:483:5: (c0= boolConjunctionElement ( ( '&&' | 'AND' ) cp=
			// boolConjunctionElement )* )
			// MLN.g:484:5: c0= boolConjunctionElement ( ( '&&' | 'AND' ) cp=
			// boolConjunctionElement )*
			{
				root_0 = (Object) adaptor.nil();
			...
			if (state.backtracking > 0) {
				memoize(input, 19, boolConjunction_StartIndex);
			}
		}
		return retval;
	}
	...
	public static class boolConjunctionElement_return extends
		ParserRuleReturnScope {
		public Expression be;
		Object tree;
	...
	// MLN.g:499:1: boolConjunctionElement returns [Expression be] : ( (negc= (
	// '!' | 'NOT' ) )? (mc= mathComparison | fe= funcExpression ) | (negb= (
	// '!' | 'NOT' ) )? '(' b= boolExpression ')' );
	public final MLNParser.boolConjunctionElement_return
		boolConjunctionElement() throws RecognitionException {
		MLNParser.boolConjunctionElement_return retval =
			new MLNParser.boolConjunctionElement_return();
		retval.start = input.LT(1);
		...
		try {
			...
			// MLN.g:500:5: ( (negc= ( '!' | 'NOT' ) )? (mc= mathComparison |
			// fe= funcExpression ) | (negb= ( '!' | 'NOT' ) )? '(' b=
			// boolExpression ')' )
			int alt41 = 2;
			switch (input.LA(1)) {
				case NOT:
			...
			switch (alt41) {
				case 1:
				// MLN.g:501:5: (negc= ( '!' | 'NOT' ) )? (mc= mathComparison |
				// fe= funcExpression )
				{
					root_0 = (Object) adaptor.nil();
					...
					} else if ((LA39_0 == STRING || LA39_0 == NUMBER
						|| LA39_0 == 23 || LA39_0 == 61)) {
						alt39 = 1;
					} else {
						if (state.backtracking > 0) {
				...
				// ')'
				{
					...
					char_literal61 =
						(Token) match(input, 23,
							FOLLOW_23_in_boolConjunctionElement2269);
					if (state.failed)
						return retval;
					if (state.backtracking == 0) {
						char_literal61_tree =
					...
					char_literal62 =
						(Token) match(input, 25,
							FOLLOW_25_in_boolConjunctionElement2275);
					if (state.failed)
						return retval;
					if (state.backtracking == 0) {
						char_literal62_tree =
			...
			if (state.backtracking > 0) {
				memoize(input, 20, boolConjunctionElement_StartIndex);
			}
		}
		return retval;
	}
	...
	// MLN.g:525:1: mathComparison returns [Expression expr] : e1=
	// mathExpression op= ( '=' | '<>' | '<' | '<=' | '>' | '>=' | '!=' ) e2=
	// mathExpression ;
	public final MLNParser.mathComparison_return mathComparison()
		throws RecognitionException {
		MLNParser.mathComparison_return retval =
			new MLNParser.mathComparison_return();
		retval.start = input.LT(1);
		...
		try {
			...
			// MLN.g:526:5: (e1= mathExpression op= ( '=' | '<>' | '<' | '<=' |
			// '>' | '>=' | '!=' ) e2= mathExpression )
			// MLN.g:527:5: e1= mathExpression op= ( '=' | '<>' | '<' | '<=' |
			// '>' | '>=' | '!=' ) e2= mathExpression
			{
				root_0 = (Object) adaptor.nil();
				...
				if (state.backtracking == 0) {
					...
					Function f =
						Function.getBuiltInFunctionByName((op != null ? op
							.getText() : null));
			...
			if (state.backtracking > 0) {
				memoize(input, 21, mathComparison_StartIndex);
			}
		}
		return retval;
	}
	...
	// MLN.g:537:1: mathExpression returns [Expression expr] : t0= mathTerm (op=
	// ( '+' | '-' | '%' ) tp= mathTerm )* ;
	public final MLNParser.mathExpression_return mathExpression()
		throws RecognitionException {
		MLNParser.mathExpression_return retval =
			new MLNParser.mathExpression_return();
		retval.start = input.LT(1);
		...
		try {
					...
					switch (alt42) {
						...
						// MLN.g:543:6: op= ( '+' | '-' | '%' ) tp= mathTerm
						{
							...
							if (state.backtracking == 0) {
								...
								if ((op != null ? op.getText() : null)
									.equals("+")) {
									enew = new Expression(Function.Add);
								} else if ((op != null ? op.getText() : null)
									.equals("-")) {
			...
			if (state.backtracking > 0) {
				memoize(input, 22, mathExpression_StartIndex);
			}
		}
		return retval;
	}
	...
	// MLN.g:560:1: mathTerm returns [Expression expr] : t0= mathFactor (op= (
	// '*' | '/' | '&' | '|' | '^' | '<<' | '>>' ) tp= mathFactor )* ;
	public final MLNParser.mathTerm_return mathTerm()
		throws RecognitionException {
		...
		try {
			...
			// MLN.g:561:5: (t0= mathFactor (op= ( '*' | '/' | '&' | '|' | '^' |
			// '<<' | '>>' ) tp= mathFactor )* )
			// MLN.g:562:5: t0= mathFactor (op= ( '*' | '/' | '&' | '|' | '^' |
			// '<<' | '>>' ) tp= mathFactor )*
			{
				root_0 = (Object) adaptor.nil();
						...
						// | '>>' ) tp= mathFactor
						{
							...
							if (state.backtracking == 0) {
								...
								if ((op != null ? op.getText() : null)
									...
									.equals("<<")) {
									enew =
										new Expression(Function.BitShiftLeft);
								} else if ((op != null ? op.getText() : null)
									.equals(">>")) {
									enew =
										new Expression(Function.BitShiftRight);
								}
								enew.addArgument(retval.expr);
								enew.addArgument((tp != null ? tp.expr : null));
								retval.expr = enew;
			...
			if (state.backtracking > 0) {
				memoize(input, 23, mathTerm_StartIndex);
			}
		}
		return retval;
	}
	...
	// MLN.g:590:1: mathFactor returns [Expression expr] : (fe= funcExpression |
	// ae= atomicExpression | '(' ee= mathExpression ')' | '~' mf= mathFactor )
	// (fact= '!' )? ;
	public final MLNParser.mathFactor_return mathFactor()
		throws RecognitionException {
		...
		try {
			...
			// MLN.g:591:5: ( (fe= funcExpression | ae= atomicExpression | '('
			// ee= mathExpression ')' | '~' mf= mathFactor ) (fact= '!' )? )
			// MLN.g:592:5: (fe= funcExpression | ae= atomicExpression | '(' ee=
			// mathExpression ')' | '~' mf= mathFactor ) (fact= '!' )?
			{
				root_0 = (Object) adaptor.nil();

				// MLN.g:592:5: (fe= funcExpression | ae= atomicExpression | '('
				// ee= mathExpression ')' | '~' mf= mathFactor )
				int alt44 = 4;
				switch (input.LA(1)) {
					case ID: {
						...
						if ((LA44_1 == EOF
							|| (LA44_1 >= NOT && LA44_1 <= IMPLIES)
							|| LA44_1 == NUMBER || LA44_1 == ID || LA44_1 == 22
							|| (LA44_1 >= 24 && LA44_1 <= 25)
							|| (LA44_1 >= 31 && LA44_1 <= 35)
							|| (LA44_1 >= 37 && LA44_1 <= 38) || LA44_1 == 40
							|| (LA44_1 >= 42 && LA44_1 <= 46) || (LA44_1 >= 48 && LA44_1 <= 60))) {
							alt44 = 2;
						} else if ((LA44_1 == 23)) {
							alt44 = 1;
						} else {
				...
				switch (alt44) {
					...
					// MLN.g:597:9: ae= atomicExpression
					{
						...
						if (state.failed)
							return retval;
						if (state.backtracking == 0)
							adaptor.addChild(root_0, ae.getTree());
						if (state.backtracking == 0) {
					...
					// MLN.g:605:9: '~' mf= mathFactor
					{
						...
						if (state.failed)
							return retval;
						if (state.backtracking == 0)
							adaptor.addChild(root_0, mf.getTree());
						if (state.backtracking == 0) {
				...
				switch (alt45) {
					...
					{
						fact =
							(Token) match(input, NOT,
								FOLLOW_NOT_in_mathFactor2603);
						if (state.failed)
							return retval;
						if (state.backtracking == 0) {
			...
			if (state.backtracking > 0) {
				memoize(input, 24, mathFactor_StartIndex);
			}
		}
		return retval;
	}
	...
	// MLN.g:621:1: funcExpression returns [Expression expr] : func= ID '(' a0=
	// funcArgument ( ',' ap= funcArgument )* ')' ;
	public final MLNParser.funcExpression_return funcExpression()
		throws RecognitionException {
		MLNParser.funcExpression_return retval =
			new MLNParser.funcExpression_return();
		retval.start = input.LT(1);
		...
		try {
			...
			// MLN.g:622:5: (func= ID '(' a0= funcArgument ( ',' ap=
			// funcArgument )* ')' )
			...
			// )* ')'
			{
				...
				func =
					(Token) match(input, ID, FOLLOW_ID_in_funcExpression2638);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
					func_tree = (Object) adaptor.create(func);
				...
				if (state.backtracking == 0) {
					...
					Function f =
						ml.getFunctionByName((func != null ? func.getText()
							: null));
					if (f == null)
						die("Line #"
							+ func.getLine()
				...
				char_literal66 =
					(Token) match(input, 23, FOLLOW_23_in_funcExpression2652);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
					char_literal66_tree =
				...
				if (state.failed)
					return retval;
				if (state.backtracking == 0)
					adaptor.addChild(root_0, a0.getTree());
				if (state.backtracking == 0) {
				...
				loop46: do {
					...
					switch (alt46) {
						...
						// MLN.g:637:6: ',' ap= funcArgument
						{
							char_literal67 =
								(Token) match(input, 24,
									FOLLOW_24_in_funcExpression2671);
							if (state.failed)
								return retval;
							if (state.backtracking == 0) {
								char_literal67_tree =
							...
							if (state.backtracking == 0) {
								...
								retval.expr.addArgument((ap != null ? ap.expr
									: null));
				...
				char_literal68 =
					(Token) match(input, 25, FOLLOW_25_in_funcExpression2696);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
					char_literal68_tree =
			...
			if (state.backtracking > 0) {
				memoize(input, 25, funcExpression_StartIndex);
			}
		}
		return retval;
	}
	...
	// MLN.g:645:1: funcArgument returns [Expression expr] : (be= boolExpression
	// | me= mathExpression | fe= funcExpression | ae= atomicExpression );
	public final MLNParser.funcArgument_return funcArgument()
		throws RecognitionException {
		MLNParser.funcArgument_return retval =
			new MLNParser.funcArgument_return();
		retval.start = input.LT(1);
		...
		try {
			...
			// MLN.g:646:5: (be= boolExpression | me= mathExpression | fe=
			// funcExpression | ae= atomicExpression )
			int alt47 = 4;
			...
			switch (alt47) {
				...
				// MLN.g:651:7: me= mathExpression
				{
					...
					if (state.failed)
						return retval;
					if (state.backtracking == 0)
						adaptor.addChild(root_0, me.getTree());
					if (state.backtracking == 0) {
			...
			if (state.backtracking > 0) {
				memoize(input, 26, funcArgument_StartIndex);
			}
		}
		return retval;
	}
	...
	// MLN.g:666:1: atomicExpression returns [Expression expr] : (num= NUMBER |
	// str= STRING | id= ID );
	public final MLNParser.atomicExpression_return atomicExpression()
		throws RecognitionException {
		MLNParser.atomicExpression_return retval =
			new MLNParser.atomicExpression_return();
		retval.start = input.LT(1);
		...
		try {
			...
			switch (alt48) {
				...
				// MLN.g:668:5: num= NUMBER
				{
					...
					num =
						(Token) match(input, NUMBER,
							FOLLOW_NUMBER_in_atomicExpression2808);
					if (state.failed)
						return retval;
					if (state.backtracking == 0) {
					...
					if (state.backtracking == 0) {
						...
						try {
							int n =
								Integer.parseInt((num != null ? num.getText()
									: null));
							retval.expr = Expression.exprConstInteger(n);
						} catch (NumberFormatException e) {
							retval.expr =
								Expression.exprConstNum(Double
									.parseDouble((num != null ? num.getText()
										: null)));
						}
				...
				// MLN.g:677:7: str= STRING
				{
					...
					str =
						(Token) match(input, STRING,
							FOLLOW_STRING_in_atomicExpression2824);
					if (state.failed)
						return retval;
					if (state.backtracking == 0) {
				...
				// MLN.g:682:7: id= ID
				{
					...
					id =
						(Token) match(input, ID,
							FOLLOW_ID_in_atomicExpression2840);
					if (state.failed)
						return retval;
					if (state.backtracking == 0) {
			...
			if (state.backtracking > 0) {
				memoize(input, 27, atomicExpression_StartIndex);
			}
		}
		return retval;
	}
	...
	// $ANTLR start "literal"
	// MLN.g:695:1: literal returns [Literal lit] : (pref= ( PLUS | NOT ) )?
	// atom ;
			...
			// MLN.g:696:9: (pref= ( PLUS | NOT ) )? atom
			{
				...
				if (state.backtracking == 0) {
					...
					if (pref != null && retval.lit != null) {
						if ((pref != null ? pref.getText() : null).equals("!"))
							retval.lit.setSense(false);
						else
							retval.lit.setCoversAllMaterializedTuples(true);
					}
		...
		try {
			...
			switch (alt50) {
				...
				// MLN.g:710:5: ID
				{
					...
					ID70 = (Token) match(input, ID, FOLLOW_ID_in_term2916);
					if (state.failed)
						return retval;
					if (state.backtracking == 0) {
				...
				// MLN.g:725:7: d= ( NUMBER | STRING )
				{
					...
					if (input.LA(1) == STRING || input.LA(1) == NUMBER) {
						...
						if (state.backtracking == 0)
							adaptor
								.addChild(root_0, (Object) adaptor.create(d));
						state.errorRecovery = false;
						state.failed = false;
					} else {
						if (state.backtracking > 0) {
			...
			if (state.backtracking > 0) {
				memoize(input, 29, term_StartIndex);
			}
		}
		return retval;
	}
	...
	// $ANTLR start "atom"
	// MLN.g:737:1: atom returns [Literal lit] : pred= ID '(' term1= term ( ','
	// termp= term )* ')' ;
	public final MLNParser.atom_return atom() throws RecognitionException {
		...
		try {
			...
			// MLN.g:738:9: pred= ID '(' term1= term ( ',' termp= term )* ')'
			{
				...
				pred = (Token) match(input, ID, FOLLOW_ID_in_atom2967);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
				...
				char_literal71 =
					(Token) match(input, 23, FOLLOW_23_in_atom2969);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
					char_literal71_tree =
				...
				if (state.backtracking == 0) {
					...
					Predicate p =
						ml.getPredByName((pred != null ? pred.getText() : null));
					if (p == null)
						die("Line #" + pred.getLine()
							+ ": unknown predicate name - "
							+ (pred != null ? pred.getText() : null));
				...
				if (state.backtracking == 0) {
					...
					if ((term1 != null ? term1.t : null).isConstant())
						retval.lit.getPred().getTypeAt(
							retval.lit.getTerms().size()).addConstant(
							(term1 != null ? term1.t : null).constant());
				...
				loop51: do {
					...
					switch (alt51) {
						...
						{
							char_literal72 =
								(Token) match(input, 24, FOLLOW_24_in_atom2998);
							if (state.failed)
								return retval;
							if (state.backtracking == 0) {
								char_literal72_tree =
							...
							if (state.failed)
								return retval;
							if (state.backtracking == 0)
								adaptor.addChild(root_0, termp.getTree());
							if (state.backtracking == 0) {

								if ((termp != null ? termp.t : null)
									.isConstant())
									retval.lit.getPred().getTypeAt(
										retval.lit.getTerms().size())
										.addConstant(
											(termp != null ? termp.t : null)
												.constant());
								retval.lit.appendTerm((termp != null ? termp.t
									: null));
				...
				char_literal73 =
					(Token) match(input, 25, FOLLOW_25_in_atom3022);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
					char_literal73_tree =
				...
				if (state.backtracking == 0) {
					...
					if (retval.lit.getTerms().size() != p.arity()) {
						die("Line #" + pred.getLine()
							+ ": incorrect # of args (read "
							+ retval.lit.getTerms().size() + " but expected "
							+ p.arity() + ")" + " for pred " + p.getName());
					}
					// Register constants (to types) that only appear in the
					// program
					// if (!Config.constants_as_raw_string) {
			...
			if (state.backtracking > 0) {
				memoize(input, 30, atom_StartIndex);
			}
		}
		return retval;
	}
	...
	public final MLNParser.queryList_return queryList()
		...
		try {
			...
			// MLN.g:778:13: ( query )+ EOF
			{
					...
					switch (alt52) {
						...
						// MLN.g:0:0: query
						{
							...
							if (state.failed)
								return retval;
							if (state.backtracking == 0)
								adaptor.addChild(root_0, query74.getTree());
				...
				EOF75 = (Token) match(input, EOF, FOLLOW_EOF_in_queryList3044);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
			...
			if (state.backtracking > 0) {
				memoize(input, 31, queryList_StartIndex);
			}
		}
		return retval;
	}
	...
	public final MLNParser.query_return query() throws RecognitionException {
		...
		try {
			...
			switch (alt53) {
				...
				// MLN.g:782:3: atom
				{
					...
					if (state.backtracking == 0) {
						...
						Atom q =
							(atom76 != null ? atom76.lit : null)
								.toAtom(Atom.AtomType.QUERY);
						(atom76 != null ? atom76.lit : null).getPred()
							.addQuery(q);
				...
				// MLN.g:787:5: ID
				{
					...
					ID77 = (Token) match(input, ID, FOLLOW_ID_in_query3070);
					if (state.failed)
						return retval;
					if (state.backtracking == 0) {
					...
					if (state.backtracking == 0) {
						...
						Predicate p =
							ml.getPredByName((ID77 != null ? ID77.getText()
								: null));
						if (p == null)
							die("Line #" + ID77.getLine()
								+ ": unknown predicate name - "
								+ (ID77 != null ? ID77.getText() : null));
						p.setAllQuery();
			...
			if (state.backtracking > 0) {
				memoize(input, 32, query_StartIndex);
			}
		}
		return retval;
	}
	...
	public final MLNParser.queryCommaList_return queryCommaList()
		throws RecognitionException {
		MLNParser.queryCommaList_return retval =
			new MLNParser.queryCommaList_return();
		retval.start = input.LT(1);
		...
		try {
			...
			// MLN.g:795:18: query ( ',' query )* EOF
			{
				...
				if (state.failed)
					return retval;
				if (state.backtracking == 0)
					adaptor.addChild(root_0, query78.getTree());
				// MLN.g:795:24: ( ',' query )*
				loop54: do {
					int alt54 = 2;
					...
					switch (alt54) {
						...
						// MLN.g:795:25: ',' query
						{
							char_literal79 =
								(Token) match(input, 24,
									FOLLOW_24_in_queryCommaList3088);
							if (state.failed)
								return retval;
							if (state.backtracking == 0) {
								char_literal79_tree =
							...
							if (state.failed)
								return retval;
							if (state.backtracking == 0)
								adaptor.addChild(root_0, query80.getTree());
				...
				EOF81 =
					(Token) match(input, EOF, FOLLOW_EOF_in_queryCommaList3094);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
			...
			if (state.backtracking > 0) {
				memoize(input, 33, queryCommaList_StartIndex);
			}
		}
		return retval;
	}
	...
	public final MLNParser.evidenceList_return evidenceList()
		throws RecognitionException {
		MLNParser.evidenceList_return retval =
			new MLNParser.evidenceList_return();
		retval.start = input.LT(1);
		...
		try {
			...
			// MLN.g:798:16: ( evidence )+ EOF
			{
					...
					switch (alt55) {
						...
						// MLN.g:0:0: evidence
						{
							...
							if (state.failed)
								return retval;
							if (state.backtracking == 0)
								adaptor.addChild(root_0, evidence82.getTree());
				...
				EOF83 =
					(Token) match(input, EOF, FOLLOW_EOF_in_evidenceList3106);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
			...
			if (state.backtracking > 0) {
				memoize(input, 34, evidenceList_StartIndex);
			}
		}
		return retval;
	}
	...
	// MLN.g:801:1: evidence : (prior= NUMBER )? ( NOT )? pred= ID '(' terms+= (
	// ID | NUMBER | STRING ) ( ',' terms+= ( ID | NUMBER | STRING ) )* ')' ;
	public final MLNParser.evidence_return evidence()
		...
		try {
			...
			// MLN.g:801:10: ( (prior= NUMBER )? ( NOT )? pred= ID '(' terms+= (
			// ID | NUMBER | STRING ) ( ',' terms+= ( ID | NUMBER | STRING ) )*
			// ')' )
			// MLN.g:801:12: (prior= NUMBER )? ( NOT )? pred= ID '(' terms+= (
			// ID | NUMBER | STRING ) ( ',' terms+= ( ID | NUMBER | STRING ) )*
			// ')'
			{
				root_0 = (Object) adaptor.nil();
				...
				pred = (Token) match(input, ID, FOLLOW_ID_in_evidence3125);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
					pred_tree = (Object) adaptor.create(pred);
				...
				char_literal85 =
					(Token) match(input, 23, FOLLOW_23_in_evidence3127);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
					char_literal85_tree =
				...
				if (input.LA(1) == STRING || input.LA(1) == NUMBER
					...
					if (state.backtracking == 0)
						adaptor
							.addChild(root_0, (Object) adaptor.create(terms));
					state.errorRecovery = false;
					state.failed = false;
				} else {
					if (state.backtracking > 0) {
				...
				char_literal87 =
					(Token) match(input, 25, FOLLOW_25_in_evidence3154);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
					char_literal87_tree =
				...
				if (state.backtracking == 0) {
					...
					if (prior != null) {
						pr =
							Double.parseDouble((prior != null ? prior.getText()
								: null));
						// TODO: currently we only support non-negtaive integer
						// weight
						// if(pr > 1 || pr < 0){
						// die("Line #" + (lineOffset+pred.getLine()) + ": " +
						// (prior!=null?prior.getText():null) +
						// " - probabilities of soft evidence should be in [0,1]");
						// }
						// if(pr < 0)
					...
					Atom gp = null;
					if (pr == null) {
						gp = new Atom(p, tuple, truth);
					} else {
						gp = new Atom(p, tuple, pr);
					}
					p.addEvidence(gp);
					gp = null;
			...
			if (state.backtracking > 0) {
				memoize(input, 35, evidence_StartIndex);
			}
		}
		return retval;
	}
	...
	// $ANTLR start "trainList"
	// MLN.g:858:1: trainList : ( train )+ EOF ;
	public final MLNParser.trainList_return trainList()
		throws RecognitionException {
		MLNParser.trainList_return retval = new MLNParser.trainList_return();
		retval.start = input.LT(1);
		int trainList_StartIndex = input.index();
		Object root_0 = null;

		Token EOF89 = null;
		MLNParser.train_return train88 = null;
		...
		try {
			...
			// MLN.g:858:11: ( ( train )+ EOF )
			// MLN.g:858:13: ( train )+ EOF
			{
				root_0 = (Object) adaptor.nil();
					...
					switch (alt59) {
						...
						// MLN.g:0:0: train
						{
							...
							if (state.failed)
								return retval;
							if (state.backtracking == 0)
								adaptor.addChild(root_0, train88.getTree());
				...
				EOF89 = (Token) match(input, EOF, FOLLOW_EOF_in_trainList3181);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
					EOF89_tree = (Object) adaptor.create(EOF89);
					adaptor.addChild(root_0, EOF89_tree);
				}
			...
			if (state.backtracking > 0) {
				memoize(input, 36, trainList_StartIndex);
			}
		}
		return retval;
	}
	...
	// $ANTLR start "train"
	// MLN.g:861:1: train : ( NOT )? pred= ID '(' terms+= ( ID | NUMBER | STRING
	// ) ( ',' terms+= ( ID | NUMBER | STRING ) )* ')' ;
	public final MLNParser.train_return train() throws RecognitionException {
		MLNParser.train_return retval = new MLNParser.train_return();
		retval.start = input.LT(1);
		int train_StartIndex = input.index();
		Object root_0 = null;
		...
		try {
			...
			// MLN.g:861:7: ( ( NOT )? pred= ID '(' terms+= ( ID | NUMBER |
			// STRING ) ( ',' terms+= ( ID | NUMBER | STRING ) )* ')' )
			// MLN.g:861:9: ( NOT )? pred= ID '(' terms+= ( ID | NUMBER | STRING
			// ) ( ',' terms+= ( ID | NUMBER | STRING ) )* ')'
			{
				root_0 = (Object) adaptor.nil();
				...
				switch (alt60) {
					...
					{
						NOT90 =
							(Token) match(input, NOT, FOLLOW_NOT_in_train3190);
						if (state.failed)
							return retval;
						if (state.backtracking == 0) {
							NOT90_tree = (Object) adaptor.create(NOT90);
							adaptor.addChild(root_0, NOT90_tree);
						}
				...
				pred = (Token) match(input, ID, FOLLOW_ID_in_train3195);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
					pred_tree = (Object) adaptor.create(pred);
				...
				char_literal91 =
					(Token) match(input, 23, FOLLOW_23_in_train3197);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
					char_literal91_tree =
				...
				// MLN.g:861:52: ( ',' terms+= ( ID | NUMBER | STRING ) )*
				loop61: do {
					int alt61 = 2;
					...
					switch (alt61) {
						case 1:
						// MLN.g:861:53: ',' terms+= ( ID | NUMBER | STRING )
						{
							char_literal92 =
								(Token) match(input, 24, FOLLOW_24_in_train3210);
							if (state.failed)
								return retval;
							if (state.backtracking == 0) {
								char_literal92_tree =
				...
				char_literal93 =
					(Token) match(input, 25, FOLLOW_25_in_train3224);
				if (state.failed)
					return retval;
				if (state.backtracking == 0) {
					char_literal93_tree =
				...
				if (state.backtracking == 0) {
					...
					for (int i = 0; i < p.arity(); i++) {
						...
						Type type = p.getTypeAt(i);
						String s = t.getText();
						Integer sid = this.ml.getSymbolID(s, type);
						args.add(sid.toString());
						tuple.add(sid);
					}
					Atom gp = null;
			...
			if (state.backtracking > 0) {
				memoize(input, 37, train_StartIndex);
			}
		}
		return retval;
	}
	...
	public final void synpred52_MLN_fragment() throws RecognitionException {
		...
		// MLN.g:501:5: ( (negc= ( '!' | 'NOT' ) )? (mc= mathComparison | fe=
		// funcExpression ) )
		// MLN.g:501:5: (negc= ( '!' | 'NOT' ) )? (mc= mathComparison | fe=
		// funcExpression )
		{
			...
			} else if ((LA67_0 == STRING || LA67_0 == NUMBER || LA67_0 == 23 || LA67_0 == 61)) {
				alt67 = 1;
			} else {
				if (state.backtracking > 0) {
					state.failed = true;
	...
	public final void synpred75_MLN_fragment() throws RecognitionException {
		...
		// MLN.g:611:11: fact= '!'
		{
			fact = (Token) match(input, NOT, FOLLOW_NOT_in_synpred75_MLN2603);
			if (state.failed)
				return;
	...
	static final String DFA1_eofS = "\1\1\15\uffff\1\5\1\uffff\1\5\2\uffff";
	...
	static final String DFA1_acceptS = "\1\uffff\1\3\3\uffff\1\1\1\2\14\uffff";
	...
	static final String DFA11_eotS = "\21\uffff";
	static final String DFA11_eofS = "\1\1\20\uffff";
	...
	static final String DFA11_specialS = "\21\uffff}>";
	static final String[] DFA11_transitionS = {
		"\2\5\3\uffff\1\2\6\uffff\1\2\1\uffff\1\4\1\uffff\1\3\10\uffff"
			+ "\3\2\2\7\1\uffff\1\6", "", "",
		"\2\7\12\uffff\1\2\1\uffff\1\10\16\uffff\1\7", "\1\11\4\uffff\1\2",
		"\1\12", "", "", "\1\7\4\uffff\1\2", "\1\14\3\uffff\1\14\1\uffff\1\13",
		"\1\11", "\1\15\1\16", "\1\15\1\16", "\1\20\3\uffff\1\20\1\uffff\1\17",
	...
	static final String DFA20_eotS = "\16\uffff";
	static final String DFA20_eofS = "\16\uffff";
	static final String DFA20_minS = "\1\12\1\6\1\uffff\1\6\1\uffff\11\6";
	static final String DFA20_maxS =
		"\1\30\1\75\1\uffff\1\74\1\uffff\1\75\3\74\1\75\4\74";
	static final String DFA20_acceptS = "\2\uffff\1\2\1\uffff\1\1\11\uffff";
	static final String DFA20_specialS = "\16\uffff}>";
	...
	static final String DFA24_eotS = "\16\uffff";
	static final String DFA24_eofS = "\16\uffff";
	static final String DFA24_minS = "\1\12\1\6\1\uffff\1\6\1\uffff\11\6";
	static final String DFA24_maxS =
		"\1\30\1\75\1\uffff\1\74\1\uffff\1\75\3\74\1\75\4\74";
	static final String DFA24_acceptS = "\2\uffff\1\2\1\uffff\1\1\11\uffff";
	static final String DFA24_specialS = "\16\uffff}>";
	...
	static final String DFA31_eotS = "\14\uffff";
	static final String DFA31_eofS = "\7\uffff\1\12\4\uffff";
	static final String DFA31_minS =
		"\1\6\1\24\1\27\1\16\2\30\1\16\1\6\2\30\2\uffff";
	static final String DFA31_maxS =
		"\2\24\1\27\1\24\2\31\1\24\1\52\2\31\2\uffff";
	static final String DFA31_acceptS = "\12\uffff\1\2\1\1";
	static final String DFA31_specialS = "\14\uffff}>";
	...
	static final String DFA28_eotS = "\16\uffff";
	static final String DFA28_eofS = "\16\uffff";
	static final String DFA28_minS = "\1\14\1\6\2\uffff\12\6";
	static final String DFA28_maxS =
		"\1\30\1\75\2\uffff\1\74\1\75\3\74\1\75\4\74";
	static final String DFA28_acceptS = "\2\uffff\1\2\1\1\12\uffff";
	static final String DFA28_specialS = "\16\uffff}>";
	...
	static final String DFA32_eotS = "\32\uffff";
	static final String DFA32_eofS = "\1\2\11\uffff\1\3\17\uffff";
	static final String DFA32_minS = "\2\6\2\uffff\12\6\1\7\1\16\12\6";
	static final String DFA32_maxS =
		"\1\52\1\75\2\uffff\1\74\1\75\3\74\1\75\5\74\1\75\1\74\1\75\3\74"
			+ "\1\75\4\74";
	static final String DFA32_acceptS = "\2\uffff\1\2\1\1\26\uffff";
	static final String DFA32_specialS = "\32\uffff}>";
	...
	static final String DFA42_eotS = "\16\uffff";
	static final String DFA42_eofS = "\1\1\3\uffff\1\3\11\uffff";
	static final String DFA42_minS = "\1\6\1\uffff\1\16\1\uffff\6\6\1\0\3\6";
	static final String DFA42_maxS =
		"\1\66\1\uffff\1\75\1\uffff\1\74\1\75\3\74\1\75\1\0\3\74";
	static final String DFA42_acceptS = "\1\uffff\1\2\1\uffff\1\1\12\uffff";
	static final String DFA42_specialS = "\12\uffff\1\0\3\uffff}>";
	...
	static final char[] DFA42_min = DFA
		.unpackEncodedStringToUnsignedChars(DFA42_minS);
	static final char[] DFA42_max = DFA
		.unpackEncodedStringToUnsignedChars(DFA42_maxS);
	static final short[] DFA42_accept = DFA.unpackEncodedString(DFA42_acceptS);
	static final short[] DFA42_special = DFA
		.unpackEncodedString(DFA42_specialS);
	...
	static final String DFA47_eotS = "\12\uffff";
	static final String DFA47_eofS = "\12\uffff";
	static final String DFA47_minS = "\1\6\1\uffff\5\0\3\uffff";
	static final String DFA47_maxS = "\1\75\1\uffff\5\0\3\uffff";
	static final String DFA47_acceptS = "\1\uffff\1\1\5\uffff\1\2\1\3\1\4";
	...
	static final char[] DFA47_min = DFA
		.unpackEncodedStringToUnsignedChars(DFA47_minS);
	static final char[] DFA47_max = DFA
		.unpackEncodedStringToUnsignedChars(DFA47_maxS);
	static final short[] DFA47_accept = DFA.unpackEncodedString(DFA47_acceptS);
	static final short[] DFA47_special = DFA
		.unpackEncodedString(DFA47_specialS);
		...
		public int specialStateTransition(int s, IntStream _input)
			...
			switch (s) {
				case 0:
					...
					else if ((synpred78_MLN())) {
						s = 7;
					}

					else if ((synpred79_MLN())) {
						s = 8;
					}
	...
	public static final BitSet FOLLOW_schemaList_in_definitions895 =
		new BitSet(new long[] { 0x0000002F805408C0L });
	public static final BitSet FOLLOW_ruleList_in_definitions897 = new BitSet(
		new long[] { 0x0000000000000000L });
	public static final BitSet FOLLOW_EOF_in_definitions899 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_schema_in_schemaList908 = new BitSet(
		new long[] { 0x000000000C700282L });
	public static final BitSet FOLLOW_schemaConstraint_in_schemaList912 =
		new BitSet(new long[] { 0x000000000C700282L });
	public static final BitSet FOLLOW_PLUS_in_schema925 = new BitSet(
		new long[] { 0x0000000000700200L });
	public static final BitSet FOLLOW_21_in_schema932 = new BitSet(
		new long[] { 0x0000000000500000L });
	public static final BitSet FOLLOW_ASTERISK_in_schema936 = new BitSet(
		new long[] { 0x0000000000500000L });
	public static final BitSet FOLLOW_22_in_schema943 = new BitSet(
		new long[] { 0x0000000000100000L });
	public static final BitSet FOLLOW_ID_in_schema949 = new BitSet(
		new long[] { 0x0000000000800200L });
	public static final BitSet FOLLOW_ASTERISK_in_schema953 = new BitSet(
		new long[] { 0x0000000000800000L });
	public static final BitSet FOLLOW_23_in_schema960 = new BitSet(
		new long[] { 0x0000000000100000L });
	public static final BitSet FOLLOW_predArg_in_schema964 = new BitSet(
		new long[] { 0x0000000003000000L });
	public static final BitSet FOLLOW_24_in_schema967 = new BitSet(
		new long[] { 0x0000000000100000L });
	public static final BitSet FOLLOW_predArg_in_schema971 = new BitSet(
		new long[] { 0x0000000003000000L });
	public static final BitSet FOLLOW_25_in_schema975 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_ID_in_predArg990 = new BitSet(
		new long[] { 0x0000000000100042L });
	public static final BitSet FOLLOW_ID_in_predArg995 = new BitSet(
		new long[] { 0x0000000000000042L });
	public static final BitSet FOLLOW_NOT_in_predArg1001 = new BitSet(
		new long[] { 0x0000000000000002L });
	...
	public static final BitSet FOLLOW_ID_in_functionalDependencyItem1070 =
		new BitSet(new long[] { 0x0000000041000000L });
	...
	public static final BitSet FOLLOW_ID_in_functionalDependencyItem1085 =
		new BitSet(new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_mlnRule_in_ruleList1103 = new BitSet(
		new long[] { 0x0000002F805408C2L });
	public static final BitSet FOLLOW_scopingRule_in_ruleList1107 = new BitSet(
		new long[] { 0x0000002F805408C2L });
	public static final BitSet FOLLOW_datalogRule_in_ruleList1111 = new BitSet(
		new long[] { 0x0000002F805408C2L });
	public static final BitSet FOLLOW_set_in_mlnRule1144 = new BitSet(
		new long[] { 0x0000000000004000L });
	public static final BitSet FOLLOW_STRING_in_mlnRule1152 = new BitSet(
		new long[] { 0x00000003805408C0L });
	public static final BitSet FOLLOW_softRule_in_mlnRule1173 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_hardRule_in_mlnRule1177 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_22_in_softRule1204 = new BitSet(
		new long[] { 0x0000000000040000L });
	public static final BitSet FOLLOW_NUMBER_in_softRule1210 = new BitSet(
		new long[] { 0x00000003805408C0L });
	public static final BitSet FOLLOW_foclause_in_softRule1214 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_22_in_softRule1235 = new BitSet(
		new long[] { 0x0000000000100000L });
	public static final BitSet FOLLOW_ID_in_softRule1241 = new BitSet(
		new long[] { 0x0000000010000000L });
	public static final BitSet FOLLOW_28_in_softRule1243 = new BitSet(
		new long[] { 0x00000003805408C0L });
	public static final BitSet FOLLOW_foclause_in_softRule1247 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_foclause_in_hardRule1280 = new BitSet(
		new long[] { 0x0000000000000400L });
	public static final BitSet FOLLOW_PERIOD_in_hardRule1282 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_ID_in_functionalAtom1317 = new BitSet(
		new long[] { 0x0000000000800000L });
	public static final BitSet FOLLOW_23_in_functionalAtom1330 = new BitSet(
		new long[] { 0x2000000000944000L });
	public static final BitSet FOLLOW_expression_in_functionalAtom1339 =
		new BitSet(new long[] { 0x0000000003000000L });
	public static final BitSet FOLLOW_24_in_functionalAtom1355 = new BitSet(
		new long[] { 0x2000000000944000L });
	public static final BitSet FOLLOW_expression_in_functionalAtom1359 =
		new BitSet(new long[] { 0x0000000003000000L });
	public static final BitSet FOLLOW_25_in_functionalAtom1382 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_set_in_datalogRule1408 = new BitSet(
		new long[] { 0x00000008001000C0L });
	public static final BitSet FOLLOW_35_in_datalogRule1419 = new BitSet(
		new long[] { 0x00000000001000C0L });
	public static final BitSet FOLLOW_literal_in_datalogRule1425 = new BitSet(
		new long[] { 0x0000001000000000L });
	public static final BitSet FOLLOW_36_in_datalogRule1429 = new BitSet(
		new long[] { 0x00000000001000C0L });
	public static final BitSet FOLLOW_literal_in_datalogRule1441 = new BitSet(
		new long[] { 0x0000000001000400L });
	public static final BitSet FOLLOW_24_in_datalogRule1454 = new BitSet(
		new long[] { 0x00000000001000C0L });
	public static final BitSet FOLLOW_literal_in_datalogRule1458 = new BitSet(
		new long[] { 0x0000000001000400L });
	public static final BitSet FOLLOW_24_in_datalogRule1473 = new BitSet(
		new long[] { 0x2000000000944000L });
	public static final BitSet FOLLOW_mathComparison_in_datalogRule1477 =
		new BitSet(new long[] { 0x0000000001000400L });
	public static final BitSet FOLLOW_24_in_datalogRule1491 = new BitSet(
		new long[] { 0x0000002000000000L });
	public static final BitSet FOLLOW_37_in_datalogRule1493 = new BitSet(
		new long[] { 0x2000800000944040L });
	public static final BitSet FOLLOW_boolExpression_in_datalogRule1508 =
		new BitSet(new long[] { 0x0000004000000000L });
	public static final BitSet FOLLOW_38_in_datalogRule1519 = new BitSet(
		new long[] { 0x0000000000000400L });
	public static final BitSet FOLLOW_PERIOD_in_datalogRule1528 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_37_in_scopingRule1561 = new BitSet(
		new long[] { 0x0000008000000000L });
	public static final BitSet FOLLOW_39_in_scopingRule1563 = new BitSet(
		new long[] { 0x0000010000000000L });
	public static final BitSet FOLLOW_40_in_scopingRule1565 = new BitSet(
		new long[] { 0x0000000000040000L });
	public static final BitSet FOLLOW_NUMBER_in_scopingRule1569 = new BitSet(
		new long[] { 0x0000004000000000L });
	public static final BitSet FOLLOW_38_in_scopingRule1571 = new BitSet(
		new long[] { 0x00000000001000C0L });
	public static final BitSet FOLLOW_literal_in_scopingRule1577 = new BitSet(
		new long[] { 0x0000020000000000L });
	public static final BitSet FOLLOW_41_in_scopingRule1581 = new BitSet(
		new long[] { 0x00000000001000C0L });
	public static final BitSet FOLLOW_literal_in_scopingRule1593 = new BitSet(
		new long[] { 0x0000000001000400L });
	public static final BitSet FOLLOW_24_in_scopingRule1606 = new BitSet(
		new long[] { 0x00000000001000C0L });
	public static final BitSet FOLLOW_literal_in_scopingRule1610 = new BitSet(
		new long[] { 0x0000000001000400L });
	public static final BitSet FOLLOW_24_in_scopingRule1625 = new BitSet(
		new long[] { 0x2000000000944000L });
	public static final BitSet FOLLOW_mathComparison_in_scopingRule1629 =
		new BitSet(new long[] { 0x0000000001000400L });
	public static final BitSet FOLLOW_24_in_scopingRule1643 = new BitSet(
		new long[] { 0x0000002000000000L });
	public static final BitSet FOLLOW_37_in_scopingRule1645 = new BitSet(
		new long[] { 0x2000800000944040L });
	public static final BitSet FOLLOW_boolExpression_in_scopingRule1660 =
		new BitSet(new long[] { 0x0000004000000000L });
	public static final BitSet FOLLOW_38_in_scopingRule1671 = new BitSet(
		new long[] { 0x0000000000000400L });
	public static final BitSet FOLLOW_PERIOD_in_scopingRule1680 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_existQuan_in_foclause1717 = new BitSet(
		new long[] { 0x00000000001000C0L });
	public static final BitSet FOLLOW_literal_in_foclause1739 = new BitSet(
		new long[] { 0x0000000001001000L });
	public static final BitSet FOLLOW_24_in_foclause1752 = new BitSet(
		new long[] { 0x00000000001000C0L });
	public static final BitSet FOLLOW_literal_in_foclause1756 = new BitSet(
		new long[] { 0x0000000001001000L });
	public static final BitSet FOLLOW_24_in_foclause1771 = new BitSet(
		new long[] { 0x2000000000944000L });
	public static final BitSet FOLLOW_mathComparison_in_foclause1775 =
		new BitSet(new long[] { 0x0000000001001000L });
	public static final BitSet FOLLOW_24_in_foclause1788 = new BitSet(
		new long[] { 0x0000002000000000L });
	public static final BitSet FOLLOW_37_in_foclause1790 = new BitSet(
		new long[] { 0x2000800000944040L });
	public static final BitSet FOLLOW_boolExpression_in_foclause1804 =
		new BitSet(new long[] { 0x0000004000000000L });
	public static final BitSet FOLLOW_38_in_foclause1814 = new BitSet(
		new long[] { 0x0000000000001000L });
	public static final BitSet FOLLOW_IMPLIES_in_foclause1835 = new BitSet(
		new long[] { 0x00000000001000C0L });
	public static final BitSet FOLLOW_literal_in_foclause1853 = new BitSet(
		new long[] { 0x0000040000000002L });
	public static final BitSet FOLLOW_42_in_foclause1863 = new BitSet(
		new long[] { 0x00000000001000C0L });
	public static final BitSet FOLLOW_literal_in_foclause1867 = new BitSet(
		new long[] { 0x0000040000000002L });
	public static final BitSet FOLLOW_42_in_foclause1882 = new BitSet(
		new long[] { 0x2000000000944000L });
	public static final BitSet FOLLOW_mathComparison_in_foclause1886 =
		new BitSet(new long[] { 0x0000040000000002L });
	public static final BitSet FOLLOW_42_in_foclause1904 = new BitSet(
		new long[] { 0x0000002000000000L });
	public static final BitSet FOLLOW_37_in_foclause1906 = new BitSet(
		new long[] { 0x2000800000944040L });
	public static final BitSet FOLLOW_boolExpression_in_foclause1919 =
		new BitSet(new long[] { 0x0000004000000000L });
	public static final BitSet FOLLOW_38_in_foclause1928 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_EXIST_in_existQuan1959 = new BitSet(
		new long[] { 0x0000000000100000L });
	public static final BitSet FOLLOW_ID_in_existQuan1971 = new BitSet(
		new long[] { 0x0000000001000002L });
	public static final BitSet FOLLOW_24_in_existQuan1984 = new BitSet(
		new long[] { 0x0000000000100000L });
	public static final BitSet FOLLOW_ID_in_existQuan1988 = new BitSet(
		new long[] { 0x0000000001000002L });
	...
	public static final BitSet FOLLOW_boolConjunction_in_boolExpression2042 =
		new BitSet(new long[] { 0x0000180000000002L });
	public static final BitSet FOLLOW_set_in_boolExpression2064 = new BitSet(
		new long[] { 0x2000800000944040L });
	...
	public static final BitSet FOLLOW_boolConjunctionElement_in_boolConjunction2118 =
		new BitSet(new long[] { 0x0000600000000002L });
	public static final BitSet FOLLOW_set_in_boolConjunction2140 = new BitSet(
		new long[] { 0x2000800000944040L });
	...
	public static final BitSet FOLLOW_set_in_boolConjunctionElement2194 =
		new BitSet(new long[] { 0x2000000000944000L });
	...
	public static final BitSet FOLLOW_23_in_boolConjunctionElement2269 =
		new BitSet(new long[] { 0x2000800000944040L });
	...
	public static final BitSet FOLLOW_mathExpression_in_mathComparison2309 =
		new BitSet(new long[] { 0x003F010000000000L });
	public static final BitSet FOLLOW_set_in_mathComparison2313 = new BitSet(
		new long[] { 0x2000000000944000L });
	...
	public static final BitSet FOLLOW_mathTerm_in_mathExpression2365 =
		new BitSet(new long[] { 0x0040000000000182L });
	public static final BitSet FOLLOW_set_in_mathExpression2381 = new BitSet(
		new long[] { 0x2000000000944000L });
	public static final BitSet FOLLOW_mathTerm_in_mathExpression2391 =
		new BitSet(new long[] { 0x0040000000000182L });
	public static final BitSet FOLLOW_mathFactor_in_mathTerm2436 = new BitSet(
		new long[] { 0x1F80000000000202L });
	public static final BitSet FOLLOW_set_in_mathTerm2452 = new BitSet(
		new long[] { 0x2000000000944000L });
	public static final BitSet FOLLOW_mathFactor_in_mathTerm2470 = new BitSet(
		new long[] { 0x1F80000000000202L });
	...
	public static final BitSet FOLLOW_atomicExpression_in_mathFactor2539 =
		new BitSet(new long[] { 0x0000000000000042L });
	public static final BitSet FOLLOW_23_in_mathFactor2557 = new BitSet(
		new long[] { 0x2000000000944000L });
	public static final BitSet FOLLOW_mathExpression_in_mathFactor2561 =
		new BitSet(new long[] { 0x0000000002000000L });
	public static final BitSet FOLLOW_25_in_mathFactor2563 = new BitSet(
		new long[] { 0x0000000000000042L });
	public static final BitSet FOLLOW_61_in_mathFactor2581 = new BitSet(
		new long[] { 0x2000000000944000L });
	public static final BitSet FOLLOW_mathFactor_in_mathFactor2585 =
		new BitSet(new long[] { 0x0000000000000042L });
	public static final BitSet FOLLOW_NOT_in_mathFactor2603 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_ID_in_funcExpression2638 = new BitSet(
		new long[] { 0x0000000000800000L });
	public static final BitSet FOLLOW_23_in_funcExpression2652 = new BitSet(
		new long[] { 0x2000800000944040L });
	public static final BitSet FOLLOW_funcArgument_in_funcExpression2656 =
		new BitSet(new long[] { 0x0000000003000000L });
	public static final BitSet FOLLOW_24_in_funcExpression2671 = new BitSet(
		new long[] { 0x2000800000944040L });
	public static final BitSet FOLLOW_funcArgument_in_funcExpression2675 =
		new BitSet(new long[] { 0x0000000003000000L });
	public static final BitSet FOLLOW_25_in_funcExpression2696 = new BitSet(
		new long[] { 0x0000000000000002L });
	...
	public static final BitSet FOLLOW_STRING_in_atomicExpression2824 =
		new BitSet(new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_ID_in_atomicExpression2840 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_set_in_literal2876 = new BitSet(
		new long[] { 0x00000000001000C0L });
	public static final BitSet FOLLOW_atom_in_literal2884 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_ID_in_term2916 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_set_in_term2932 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_ID_in_atom2967 = new BitSet(
		new long[] { 0x0000000000800000L });
	public static final BitSet FOLLOW_23_in_atom2969 = new BitSet(
		new long[] { 0x0000000000144000L });
	public static final BitSet FOLLOW_term_in_atom2984 = new BitSet(
		new long[] { 0x0000000003000000L });
	public static final BitSet FOLLOW_24_in_atom2998 = new BitSet(
		new long[] { 0x0000000000144000L });
	public static final BitSet FOLLOW_term_in_atom3007 = new BitSet(
		new long[] { 0x0000000003000000L });
	public static final BitSet FOLLOW_25_in_atom3022 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_query_in_queryList3041 = new BitSet(
		new long[] { 0x00000000001000C0L });
	public static final BitSet FOLLOW_EOF_in_queryList3044 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_atom_in_query3060 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_ID_in_query3070 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_query_in_queryCommaList3085 = new BitSet(
		new long[] { 0x0000000001000000L });
	public static final BitSet FOLLOW_24_in_queryCommaList3088 = new BitSet(
		new long[] { 0x00000000001000C0L });
	public static final BitSet FOLLOW_query_in_queryCommaList3090 = new BitSet(
		new long[] { 0x0000000001000000L });
	public static final BitSet FOLLOW_EOF_in_queryCommaList3094 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_evidence_in_evidenceList3103 =
		new BitSet(new long[] { 0x0000000000140040L });
	public static final BitSet FOLLOW_EOF_in_evidenceList3106 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_NUMBER_in_evidence3117 = new BitSet(
		new long[] { 0x0000000000100040L });
	public static final BitSet FOLLOW_NOT_in_evidence3120 = new BitSet(
		new long[] { 0x0000000000100000L });
	public static final BitSet FOLLOW_ID_in_evidence3125 = new BitSet(
		new long[] { 0x0000000000800000L });
	public static final BitSet FOLLOW_23_in_evidence3127 = new BitSet(
		new long[] { 0x0000000000144000L });
	public static final BitSet FOLLOW_set_in_evidence3131 = new BitSet(
		new long[] { 0x0000000003000000L });
	public static final BitSet FOLLOW_24_in_evidence3140 = new BitSet(
		new long[] { 0x0000000000144000L });
	public static final BitSet FOLLOW_set_in_evidence3144 = new BitSet(
		new long[] { 0x0000000003000000L });
	public static final BitSet FOLLOW_25_in_evidence3154 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_train_in_trainList3178 = new BitSet(
		new long[] { 0x0000000000100040L });
	public static final BitSet FOLLOW_EOF_in_trainList3181 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_NOT_in_train3190 = new BitSet(
		new long[] { 0x0000000000100000L });
	public static final BitSet FOLLOW_ID_in_train3195 = new BitSet(
		new long[] { 0x0000000000800000L });
	public static final BitSet FOLLOW_23_in_train3197 = new BitSet(
		new long[] { 0x0000000000144000L });
	public static final BitSet FOLLOW_set_in_train3201 = new BitSet(
		new long[] { 0x0000000003000000L });
	public static final BitSet FOLLOW_24_in_train3210 = new BitSet(
		new long[] { 0x0000000000144000L });
	public static final BitSet FOLLOW_set_in_train3214 = new BitSet(
		new long[] { 0x0000000003000000L });
	public static final BitSet FOLLOW_25_in_train3224 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_mathComparison_in_synpred51_MLN2222 =
		new BitSet(new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_set_in_synpred52_MLN2194 = new BitSet(
		new long[] { 0x2000000000944000L });
	...
	public static final BitSet FOLLOW_funcExpression_in_synpred52_MLN2235 =
		new BitSet(new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_set_in_synpred64_MLN2381 = new BitSet(
		new long[] { 0x2000000000944000L });
	public static final BitSet FOLLOW_mathTerm_in_synpred64_MLN2391 =
		new BitSet(new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_NOT_in_synpred75_MLN2603 = new BitSet(
		new long[] { 0x0000000000000002L });
