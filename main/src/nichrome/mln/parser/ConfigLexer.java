...
public class ConfigLexer extends Lexer {
	...
	public final void mWS() throws RecognitionException {
		try {
			int _type = ConfigLexer.WS;
			int _channel = BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
			// /scratch/leonn/workspace/tuffy/src/tuffy/parse/Config.g:19:5: ( (
			// ' ' | '\\r' | '\\n' | '\\t' ) )
			// /scratch/leonn/workspace/tuffy/src/tuffy/parse/Config.g:19:9: (
			// ' ' | '\\r' | '\\n' | '\\t' )
			{
			...
			// '#' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n' ) )
			{
				...
				// ( '#' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n' )
				{
					...
					// '#' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n'
					{
						...
						// /scratch/leonn/workspace/tuffy/src/tuffy/parse/Config.g:27:29:
						// ( '\\r' )?
						int alt2 = 2;
	...
	public final void mSPAN() throws RecognitionException {
		try {
			int _type = ConfigLexer.SPAN;
			int _channel = BaseRecognizer.DEFAULT_TOKEN_CHANNEL;
			// /scratch/leonn/workspace/tuffy/src/tuffy/parse/Config.g:30:5: ( (
			// 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' | ':' | '/' |
			// '\\\\' | '\\.' )+ )
			// /scratch/leonn/workspace/tuffy/src/tuffy/parse/Config.g:30:7: (
			// 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' | ':' | '/' |
			// '\\\\' | '\\.' )+
			{
				// /scratch/leonn/workspace/tuffy/src/tuffy/parse/Config.g:30:7:
	...
	public void mTokens() throws RecognitionException {
		// /scratch/leonn/workspace/tuffy/src/tuffy/parse/Config.g:1:8: ( T__7 |
		// WS | COMMENT | SPAN )
		int alt4 = 4;
		...
		switch (alt4) {
			case 1:
			// /scratch/leonn/workspace/tuffy/src/tuffy/parse/Config.g:1:10:
			// T__7
			{
				this.mT__7();
			...
			// /scratch/leonn/workspace/tuffy/src/tuffy/parse/Config.g:1:15: WS
			{
				...
				break;
			case 3:
			// /scratch/leonn/workspace/tuffy/src/tuffy/parse/Config.g:1:18:
			// COMMENT
			{
				this.mCOMMENT();
				...
				break;
			case 4:
			// /scratch/leonn/workspace/tuffy/src/tuffy/parse/Config.g:1:26:
			// SPAN
			{
				this.mSPAN();
