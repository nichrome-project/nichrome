...
public class ConfigParser extends Parser {
	...
	// $ANTLR start "config"
	// /scratch/leonn/workspace/tuffy/src/tuffy/parse/Config.g:32:1: config : (
	// state )+ EOF ;
	public final ConfigParser.config_return config()
		...
		try {
			// /scratch/leonn/workspace/tuffy/src/tuffy/parse/Config.g:32:8: ( (
			// state )+ EOF )
			// /scratch/leonn/workspace/tuffy/src/tuffy/parse/Config.g:32:11: (
			// state )+ EOF
			{
				...
				loop1: do {
					...
					if ((LA1_0 == ConfigParser.SPAN)) {
						alt1 = 1;
					}

					switch (alt1) {
						case 1:
						// /scratch/leonn/workspace/tuffy/src/tuffy/parse/Config.g:32:12:
						// state
						{
							this.pushFollow(ConfigParser.FOLLOW_state_in_config196);
							state1 = this.state();

							this.state._fsp--;

							this.adaptor.addChild(root_0, state1.getTree());
				...
				EOF2 =
					(Token) this.match(this.input, ConfigParser.EOF,
						ConfigParser.FOLLOW_EOF_in_config200);
			...
			retval.tree =
				this.adaptor.errorNode(this.input, retval.start, this.input
					.LT(-1), re);
	...
	// $ANTLR start "state"
	// /scratch/leonn/workspace/tuffy/src/tuffy/parse/Config.g:34:1: state : id=
	// SPAN '=' value= SPAN ;
	public final ConfigParser.state_return state() throws RecognitionException {
		...
		try {
			// /scratch/leonn/workspace/tuffy/src/tuffy/parse/Config.g:34:7:
			// (id= SPAN '=' value= SPAN )
			// /scratch/leonn/workspace/tuffy/src/tuffy/parse/Config.g:34:9: id=
			// SPAN '=' value= SPAN
			{
				root_0 = this.adaptor.nil();

				id =
					(Token) this.match(this.input, ConfigParser.SPAN,
						ConfigParser.FOLLOW_SPAN_in_state210);
				id_tree = this.adaptor.create(id);
				this.adaptor.addChild(root_0, id_tree);

				char_literal3 =
					(Token) this.match(this.input, 7,
						ConfigParser.FOLLOW_7_in_state212);
				char_literal3_tree = this.adaptor.create(char_literal3);
				this.adaptor.addChild(root_0, char_literal3_tree);

				value =
					(Token) this.match(this.input, ConfigParser.SPAN,
						ConfigParser.FOLLOW_SPAN_in_state216);
				value_tree = this.adaptor.create(value);
				this.adaptor.addChild(root_0, value_tree);

				this.map.put((id != null ? id.getText() : null), (value != null
					? value.getText() : null));
	...
	public static final BitSet FOLLOW_state_in_config196 = new BitSet(
		new long[] { 0x0000000000000040L });
	public static final BitSet FOLLOW_EOF_in_config200 = new BitSet(
		new long[] { 0x0000000000000002L });
	public static final BitSet FOLLOW_SPAN_in_state210 = new BitSet(
		new long[] { 0x0000000000000080L });
	public static final BitSet FOLLOW_7_in_state212 = new BitSet(
		new long[] { 0x0000000000000040L });
	public static final BitSet FOLLOW_SPAN_in_state216 = new BitSet(
		new long[] { 0x0000000000000002L });
