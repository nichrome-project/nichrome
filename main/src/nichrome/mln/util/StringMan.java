...
public class StringMan {
	...
	public static String getUniqVarName() {
		return "uniqvar" + (StringMan.uniqVar++);
	}
	 ...
	 *
	 * @param parts
	 *            list substrings to be concatenated
	 * @return the resulting string
	 */
	public static String commaList(ArrayList<String> parts) {
		return StringMan.join(", ", parts);
	}
	...
	public static String commaListWithoutSpace(List<String> parts) {
		return StringMan.join(",", parts);
	}
	
	/**
	 * Concatenates multiple strings with V.
	 *
	 * @param parts
	 *            list substrings to be concatenated
	 * @return the resulting string
	 */
	public static String orList(ArrayList<String> parts) {
		return StringMan.join(" v ", parts);
	}

	/**
	 * Concatenates multiple strings with commas, and then surrounds the result
