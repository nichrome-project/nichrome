...
def doPlot(client, configs, aspect_ratio=1):
    ...
    gs = gridspec.GridSpec(1,8, wspace=0.24,hspace=0)
    ...
    pylab.ylabel('# alarms', size='medium')
    pylab.xlabel('# causes', size='medium')
 ...
 #               ncol=2, mode="expand", borderaxespad=0.)
      ...
      #      ax.yaxis.set_major_formatter(FuncFormatter(to_k))
        ...
        ax.text(0.02*x2, 0.86*y2, bench,
                ha='left', va='bottom', fontsize=32, fontweight='bold')
